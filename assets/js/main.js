  ...
  if (texto.length == 0) {
    ...
    if (texto.match(condicion)) {
     ...
     mostrarOcultar();
      ...
      alert("Esta app no admite mayusculas, números o minusculas con acentos. Intenta de nuevo!")
    } 
  }
...
function Reiniciar(){
  resultadoOculto.classList.add('oculto');
  vector.classList.remove('oculto');
  vectorGato.classList.remove('oculto');
  msnTexto.classList.remove('oculto');
  catTexto.classList.remove('oculto');
}
